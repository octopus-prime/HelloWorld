...
static_assert("b3f7"_b2.empty() == false, "bitboard b3f7 is not empty");
static_assert("b3f7"_b2.find() == "b3"_s2, "bitboard b3f7 finds b3 first");
static_assert("b3f7"_b2.count() == 2, "bitboard b3f7 has 2 bits set");
